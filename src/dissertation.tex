...
\def\myauthorfull{Caleb Dean Stanford}
...
\titleformat{\chapter}[hang]{\large\center}{APPENDICES}{0 pt}{} % Old {APPENDIX \thechapter}{0 pt}{ : }
\titlespacing*{\chapter}{0pt}{-33 pt}{6 pt} % The key value here is the -33 pts, I got to it by old fashioned measuring with a ruler....
\renewcommand{\thesection}{Appendix \Alph{section}}

\begin{appendixf}
\addtocontents{toc}{\protect\setcounter{tocdepth}{-1}} % This is to fix how appendices are shown in ToC
\addtocontents{toc}{\protect\setlength{\cftsecnumwidth}{6.2em}}
\renewcommand{\cftsecaftersnum}{.}
\addtocontents{toc}{\def\protect\cftsecaftersnum{.}}
% \addtocontents{toc}{\protect\renewcommand{\cftsecaftersnum}{.}}
\clearpage
\chapter{}
\addtocontents{toc}{\protect\setcounter{tocdepth}{1}} % This is to bring things back to normal
\addcontentsline{toc}{chapter}{APPENDICES} % You have to write here everything you want the ToC to show including \thechapter if you want numbering
