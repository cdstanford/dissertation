...
particularly Konstantinos Mamouras (for \Cref{cha:monitoring}) and Konstantinos Kallas and Filip Niksic (for \Cref{cha:distribution,cha:testing}).
...
\Cref{cha:background} incorporates material from my WPE-II Report at UPenn~\citeMain{wpe2} (of which I am the sole author), and \Cref{cha:rw} incorporates material from several of the papers in the remainder of the thesis.
