...
Much of the work in this thesis was done in close collaboration with my advisor, Rajeev Alur, and other coauthors:
particularly Konstantinos Mamouras (for \citeMain{festschrift18,pldi19,icalp17,popl19,tcs20}) and Konstantinos Kallas and Fililp Niksic (for \citeMain{oopsla20,ppopp22}).
% Doesn't need to be said
% The text in this dissertation is mine except where otherwise noted.
\Cref{5-composition}, \Cref{6-distribution}, \Cref{7-testing}, and \Cref{8-monitoring} contain material heavily borrowed from the respective publications.
I wrote all the included material in \Cref{5-composition}, the material on the programming model in \Cref{6-distribution}, one of the case studies and other miscellaneous sections in \Cref{7-testing}, and almost all the material in \Cref{8-monitoring}.
