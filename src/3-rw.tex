...
we now survey state-machine representations for performance-sensitive
data stream processing, relevant to \Cref{cha:monitoring}.
A core expressiveness problem is to enable \emph{quantitative} computations that aren't necessarily finite-state.
