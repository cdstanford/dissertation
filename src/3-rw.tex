...
High-level query languages for streaming include Streaming SQL~\cite{jain2008towards,begoli2019one}, CQL~\cite{arasu2003cql,ABW2006CQL},
CEDR~\cite{BGAH2007CEDR},
SamzaSQL~\cite{pathirage2016samzasql}, Structured Streaming~\cite{armbrust2018structured},
...
CISE~\cite{gotsman16},
and Carol~\cite{lewchenko2019sequential},
