...
% For concrete types and elements in examples (secs 4 and 5)
...
\newcommand{\deptype}[3]{\ensuremath{#1 \;\mathcal{D}\; #2 \;\mathsf{mod}\; {#3}}}
\newcommand{\indeptype}[3]{\ensuremath{#1 \;\mathcal{I}\; #2 \;\mathsf{mod}\; {#3}}}
% View of streams 3: linearizations and equivalence relation
\newcommand{\lintype}[2]{\ensuremath{#1: \mathsf{Lin}({#2})}}
\newcommand{\equivtype}[3]{\ensuremath{#1 \equiv #2 \;\mathsf{mod}\; {#3}}}
...
\newcommand{\poset}[1]{\mathsf{Poset}(#1)}
\newcommand{\posettype}[2]{\ensuremath{#1: \mathsf{Poset}({#2})}}
\newcommand{\posetlin}[2]{\ensuremath{\mathsf{poset}_{#2}(#1)}}
% Subtyping
\newcommand{\subtype}{\; \lesssim \;}
\newcommand{\subtypevert}{\ensuremath{\; \text{\rotatebox[origin=c]{-90}{$\lesssim$}} \;}}
\newcommand{\orderequiv}{\; \sim \;}
% Some abbreviations for sec4 operators and examples
\newcommand{\listtype}[1]{\ensuremath{\mathsf{List}(#1)}}
\newcommand{\seqint}{\seqleaf{\code{int}}}
\newcommand{\relint}{\relleaf{\code{int}}}
\newcommand{\seqorrel}{\makecell{\seqint{} \\ or \relint{}}}
\newcommand{\seqsepint}{\seqleaf{\code{int + \#}}}
\newcommand{\synchseqint}{\hier{\code{\#}}{\seqint{}}}
\newcommand{\synchrelint}{\hier{\code{\#}}{\relint{}}}
