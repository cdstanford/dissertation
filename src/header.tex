...
%     \normalfont\Large\bfseries\filcenter\titlerule[1pt]\vskip2pt%
%   }
%   {\RomNum{\thesection}.}
%   {5pt}
%   {}
%   [{\vskip2pt\titlerule[1pt]}]

% \sectionheader{sectionname}{sectionimage}{sectionquote}


\newcommand{\sectionheader}[3]{%
  {
    \clearpage\thispagestyle{empty}%
    \normalfont\Large\bfseries\filcenter\titlerule[1pt]\vskip10pt
    \addtocounter{section}{1}
    \RomNum{\thesection}.
    \addtocounter{section}{-1}

    #1
    \vskip10pt\titlerule[1pt]
  }
...
% \newcommand{\pic}[1]{\clearpage\includegraphics[width=\textwidth]{#1}\clearpage}
