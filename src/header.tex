...
\titleformat{\section}[display]
  {%
    ...
    \normalfont\Large\bfseries\filcenter\titlerule[1pt]\vskip5pt%
  }
  {\RomNum{\thesection}.}
  {5pt}
  {}
  [{\vskip2pt\titlerule[1pt]\vspace{0.8cm} \noindent}]
...
\newcommand{\sectionheaderblock}[1]{
  \begin{center}
    #1
  \end{center}
  \vspace{2cm}
...
\newcommand{\headerquote}[2]{\textit{#1 \qquad ---#2}}
\newcommand{\headerbreak}{\vspace{1cm}}
