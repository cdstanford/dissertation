...
% dummy citations to please bibtex -- TODO remove
\citeMain{pods21,festschrift18,pldi19}\cite{StreamQRE}
...
% - Lin(S) is the same as a sequence of Events(S)
