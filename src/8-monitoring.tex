...
For a finite set $X$, we write the set of functions $X \to \cdata$ as $\cdata^X$; its elements are un-tagged \emph{data vectors}, denoted $\trc{x}$, $\trc{y}$.
