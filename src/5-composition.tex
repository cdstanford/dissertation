\section{Composing Stream Operators}
\headerblock{%
  ...
  \headerquote{[A] good concept is one that is closed 1. under arbitrary composition 2. under recursion.}{Gilles Kahn~\cite{gilles1974semantics}}
}
...
\subsubsection{Relation to Data-Trace Types}
...
\subsubsection{Schema Subtyping}
...
\subsection{Programming with Data-Trace Types}
\label{subsec:dtt-2}
