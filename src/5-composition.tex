...
we continue the example schema from \Cref{45:ssec:illustrative-example}
(\Cref{45:fig:example-schema}) as the input type.
...
Next, we define the partitioned SPST that computes the total distance travelled by all taxis (according to the taxi example described in \Cref{45:ssec:illustrative-example}).
%
