...
Finally, we define three key properties that are relevant to the reset of the thesis: montonicity, type safety, and determinism for operators over streams.
