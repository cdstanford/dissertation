...
Stream type relaxation is decidable in quadratic time. That is, on input two stream types $S_1$ and $S_2$, checking if $S_1 \lesssim S_2$.
\end{theorem}
\begin{proof}
...
Consequently, checking stream type equivalence is decidable in quadratic time as it is checking relaxation in both directions.
