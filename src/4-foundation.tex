...
Since it is defined inductively, $\deptype{e}{e'}{S}$ is the smallest relation defined by the above rules.
...
For completeness, such a typing judgment is given in \Cref{app:typing}.

We could alternatively have given both $\deptype{e}{e'}{S}$ and $\indeptype{e}{e'}{S}$ as a single Boolean-valued function on pairs of events,
