...
\Cref{cha:composition} is somewhat of an exception in that it only defines functions on batches, but these can also be seen as operators by applying our isomorphism from \Cref{sec:isomorphism-between-views}; see \Cref{thm:type-safe-and-deterministic-converse}.
