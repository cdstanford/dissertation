...
% TODO:
% Describe reverse example here + note about monotonicity
% Swap example interesting for monotonicity
% And finally, examples for the remaining two possibilities: No No No and No Yes No. So like Drop, but not monotone.
