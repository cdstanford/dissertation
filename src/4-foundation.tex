...
The idea of this definition is to model partially ordered streams, as in \Cref{45:fig:gps-sps}.
...
These partially ordered structures can be viewed in multiple ways, and we explore this semantically in the next subsection.
