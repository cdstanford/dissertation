...
Each chapter considers a particular definition of operators $F$ (either a domain-specific language (DSL) or a black-box program in the case of \Cref{cha:testing}).
