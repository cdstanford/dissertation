...
To show that this lifts to an operation on batches $b_1 \cdot b_2$, it remains to show that this is well-defined up to equivalence on linearizations:
\begin{proposition}
...
This implies that batch concatenation is well-defined.
\end{proposition}
\begin{proof}
TODO
\end{proof}
