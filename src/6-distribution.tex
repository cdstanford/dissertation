...
In the extended version of the paper~\citeMain{flumina-arxiv},
...
Its design is described in more detail in the extended version of the paper~\citeMain{flumina-arxiv}.
...
The proof of \Cref{dgs:theorem:correctness} can be found in the extended version of the paper~\citeMain{flumina-arxiv}.
...
We iterated on different implementations resulting in a best-effort attempt to achieve good scalability. These implementations are summarized below, and the source code is presented in the extended version of the paper~\citeMain{flumina-arxiv}.
...
The full code for the Flink implementation can be found in the extended version of the paper~\citeMain{flumina-arxiv}.
...
We implemented all three applications (source code in extended version~\citeMain{flumina-arxiv})
...
(Author's note: this material was delegated to the appendix of the original paper and can be found in the extended version~\citeMain{flumina-arxiv}.)
