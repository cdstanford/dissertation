...
The type system in \Cref{cha:foundation} can be studied and generalized in several interesting ways, including incorporating other structured stream combinators such as concatenation of stream types.
