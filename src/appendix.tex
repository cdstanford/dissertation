...
The image was generated using the \githubref{https://github.com/amueller/word\_cloud}{\texttt{wordcloud\_cli} Python tool} while crudely filtering out LaTeX-related words: comments (anything after \verb|%|), comands (words starting with \verb|/|), and selected arguments (contents inside \verb|\begin|, \verb|\end|, \verb|\label|, \verb|\Cref|, and \verb|\cite|).
