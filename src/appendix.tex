...
The following is a word cloud generated from all the text in this thesis.
The image was generated using the \githubref{https://github.com/amueller/word\_cloud}{\texttt{wordcloud\_cli} Python tool}.
