...
I used the \githubref{https://github.com/amueller/word\_cloud}{\texttt{wordcloud\_cli} Python tool} on all \verb|.tex| sources, crudely filtering out LaTeX-related words. In particular, I filtered out comments (anything after \verb|%|), commands (words starting with \verb|/|), and selected arguments (contents inside \verb|\begin|, \verb|\end|, \verb|\label|, \verb|\Cref|, and \verb|\cite|).
