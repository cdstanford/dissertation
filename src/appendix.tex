...
The image was generated using the \githubref{https://github.com/amueller/word\_cloud}{\texttt{wordcloud\_cli} Python tool} with a custom list of omitted LaTeX-related words.

\headerblock{
  \headerimage{img/wordcloud.png}
}

And here is a word cloud generated from the references (bibliography) file:

\headerblock{
  \headerimage{img/wordcloud_refs.png}
}
